...
namespace HLExtractorToolLaunchConfig
{
    class ExtractorToolLaunchConfig
    {
        bool blChooseConfig;
        ...
        XmlElement xmlDataExtractor;

        public ExtractorToolLaunchConfig()
        {
            ...
            if (FoundXML)
            {
                ...
                xmlDataExtractor = (XmlElement)currNode;

                // Get the multiple choice variable.
                try
                {
                    blChooseConfig = false;
                    strRawText = xmlDataExtractor["ChooseXML"].InnerText;
                ...
                try
                {
                    strRawText = xmlDataExtractor["DefaultProfile"].InnerText;
                    if (strRawText != "")
